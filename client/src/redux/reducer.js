import { GET_POKEMONS, GET_SEARCH, DETAIL_POKEMONS, LOADING, CLEAN,
    FILTER_TYPE, FILTER_POKEMON, GET_TYPES, ORDER_BY, ADD_POKEMON  } from "../actions/actions";
    ...
    switch(action.type) {
        ...
        case ORDER_BY:
            ...
            case FILTER_TYPE:
                ...
                let aux2 = action.payload === 'All Types' ? allTypes : allTypes.filter(el => el.types.includes(action.payload))
                console.log(aux2)                
                return {
                    ...state,
                    pokemons: aux2
            ...
            case FILTER_POKEMON:
                ...
                if(action.payload === 'All Pokemons') return { ...state, pokemons: allPokemons}
